...
3. Select "File List" at the bottom of the page. Copy and paste the file to data/raw/digital-globe-file-list in the format of "{hurricane-name}_file_list.txt" (There are already three such file lists available, which are `irma_file_list.txt`, `test2_file_list.txt`, `test_file_list.txt`)
